...
public class Combination {
	...
	public void combine(int start){
		...
		//For each letter you select, append it to the output, print the output and then generate
		//all other combinations beginning with this sequence by recursively calling
